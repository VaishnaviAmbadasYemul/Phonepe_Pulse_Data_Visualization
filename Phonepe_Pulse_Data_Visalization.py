...
# Setting up page configuration Vaishnavi Yemul
icon = Image.open("ICN.png") 
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Vaishnavi Yemul",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Vaishnavi yemul*!
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("https://github.com/VaishnaviAmbadasYemul/Phonepe_Pulse_Data_Visualization.git")
